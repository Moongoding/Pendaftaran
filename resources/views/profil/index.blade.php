        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row gx-3 mb-3">
                    ...
                    <input type="hidden" name="roles" value="{{ implode(',', $user->roles->pluck('id')->toArray()) }}">
                    {{-- <select class="form-select" name="roles[]">
                        @foreach ($roles as $role)
                        <option type="hidden" value="{{ $role->id }}" {{ in_array($role->id, $user->roles->pluck('id')->toArray()) ? 'selected' : '' }}>
                            {{ $role->name }}</option>
                        @endforeach
                    </select> --}}
